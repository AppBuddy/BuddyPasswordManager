...
public class AddEntryGUI {
  ...
  public String getWebsiteTextFieldValue() {
  ...
  public class SubmitButtonPressed implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      if(getWebsiteTextFieldValue().isEmpty()) {
        websiteLabelWarning.setVisible(true);
      }
      if(getUsernameTextFieldValue().isEmpty()) {
        usernameLabelWarning.setVisible(true);
      }
      if(getPasswordTextFieldValue().isEmpty()) {
        passwordLabelWarning.setVisible(true);
      }
      if(!getWebsiteTextFieldValue().isEmpty()
          && !getUsernameTextFieldValue().isEmpty()
          && !getPasswordTextFieldValue().isEmpty()) {
        BuddyPasswordManagerService.saveAccount(Constants.USERNAME,
            getWebsiteTextFieldValue(),
